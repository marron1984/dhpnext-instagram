          ...
          <div className="bg-white rounded-lg shadow border border-gray-200">
            ...
            <div className="divide-y divide-gray-100 max-h-[600px] overflow-y-auto">
              {filtered.length === 0 ? (
                ...
                return (
                  <button key={p.id} onClick={() => setSelectedId(p.id)} className={`w-full text-left px-4 py-3 hover:bg-gray-50 transition-colors ${selectedId === p.id ? 'bg-blue-50 border-l-2 border-blue-500' : ''}`}>
